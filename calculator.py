...
def button_click(number):
    """Function to display number in input field"""
...
def button_add():
    """Gives the functionality to add numbers"""
...
def button_subtract():
    """Gives the functionality to subtract numbers"""
...
def button_multiply():
    """Gives the functionality to multiply numbers"""
...
def button_divide():
    """Gives the functionality to divide numbers"""
...
def button_equal():
    """Gives the functionality to give the sum,product, or quotient numbers"""
